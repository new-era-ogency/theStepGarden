...
(function () {
  ...
  var SITE_CORE = {
    ...
    mapQuery: "42.6674828,27.7065999",
    /** Відкривається з кнопки «Маршрут»; без зайвих UTM/Google Ads параметрів. */
    mapsPlaceUrl:
      "https://www.google.com/maps/place/The+Step+Garden+Restaurant/@42.6649792,27.6940298,12.98z/data=!4m15!1m8!3m7!1s0x40a69f15da2b3353:0x9e3f1a5ae4fee87e!2sThe+Step+Garden+Restaurant!8m2!3d42.6674828!4d27.7065999!10e5!16s%2Fg%2F11fy53pwpl!3m5!1s0x40a69f15da2b3353:0x9e3f1a5ae4fee87e!8m2!3d42.6674828!4d27.7065999!16s%2Fg%2F11fy53pwpl!18m1!1e1?entry=ttu",
  ...
  function dishHtml(lc, item) {
    ...
    var badge = item.badge
      ...
      : "";
    return (
      '<article class="group/card motion-safe:transition-[transform,box-shadow,border-color] motion-safe:duration-500 motion-safe:ease-out motion-safe:will-change-transform hover:-translate-y-1 hover:shadow-[0_16px_56px_rgba(0,0,0,0.48)] hover:border-[rgba(197,160,89,0.32)] flex h-full flex-col overflow-hidden rounded-2xl border border-[rgba(197,160,89,0.18)] bg-[rgba(33,58,46,0.58)] shadow-[0_8px_40px_rgba(0,0,0,0.35)] backdrop-blur-[14px]">' +
      '<div class="relative aspect-video w-full overflow-hidden">' +
      '<img src="'.concat(
        esc(item.image),
        '" alt="',
        esc(name),
        '" class="h-full w-full object-cover motion-safe:transition-[transform] motion-safe:duration-[620ms] motion-safe:ease-out group-hover/card:scale-105" loading="lazy" decoding="async" />',
      ) +
  ...
  function galleryFig(lc, item, i) {
    ...
    var lbAria =
      sLb && sLb.lightboxAria
        ...
        : esc(cap);
    return (
      '<figure class="gallery-item mb-4 break-inside-avoid motion-safe:transition-[opacity,transform] motion-safe:duration-[780ms] motion-safe:ease-[cubic-bezier(0.22,1,0.36,1)] '.concat(
        motion,
        '" data-gallery-index="',
        String(i),
        '">',
      ) +
      '<div class="group relative overflow-hidden rounded-2xl border border-transparent shadow-[0_12px_40px_rgba(0,0,0,0.45)] ring-1 ring-white/[0.04] motion-safe:transition-[transform,box-shadow,border-color] motion-safe:duration-[480ms] motion-safe:ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-0.5 hover:border-[rgba(197,160,89,0.45)]">' +
      ...
      '<img src="'.concat(
        ...
        '" alt="',
        esc(cap),
        '" class="pointer-events-none h-full w-full object-cover brightness-95 saturate-[1.02] contrast-[1.02] motion-safe:transition-[transform,filter] motion-safe:duration-[640ms] motion-safe:ease-out group-hover:scale-105 group-hover:brightness-[0.85]" loading="lazy" />',
      ) +
  ...
  function buildShell(lang) {
    ...
    var tabs = MENU_TABS_LOC.map(function (t) {
      ...
      return '<button type="button" role="tab" tabindex="'.concat(
          ...
          '" aria-selected="',
          active ? "true" : "false",
          '" aria-controls="menu-grid" class="relative isolate whitespace-nowrap overflow-hidden rounded-full px-6 py-3 font-sans text-sm font-semibold uppercase tracking-[0.08em] motion-safe:transition-all motion-safe:duration-300 motion-safe:ease-out md:text-[0.875rem] ',
          active
    ...
    var deskNav = NAV_LINKS.slice(1)
      .map(function (l) {
        return '<li><a href="'.concat(
          l.href,
          '" data-nav-desktop class="nav-link motion-safe:transition-colors motion-safe:duration-200 motion-safe:ease-out rounded-full px-4 py-2 font-sans text-[0.8rem] font-medium uppercase tracking-[0.13em] text-tsg-off-white xl:text-[0.813rem] hover:text-tsg-gold-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-tsg-gold outline-offset-4" data-nav-id="',
          l.id,
          '">',
          esc(l.label),
          "</a></li>",
    ...
    var mobLinks = NAV_LINKS.map(function (l) {
      return '<a href="'.concat(
        l.href,
        '" class="js-scroll-nav motion-safe:transition-colors motion-safe:duration-200 min-h-[52px] rounded-2xl border border-white/[0.07] px-5 py-[0.9375rem] font-sans text-sm font-semibold uppercase tracking-[0.14em] text-tsg-off-white hover:border-tsg-gold/55 hover:bg-white/[0.04] hover:text-tsg-gold" data-nav-id="',
        l.id,
        '">',
        esc(l.label),
        "</a>",
    ...
    var dockBtns = NAV_LINKS.slice(1)
      .map(function (l) {
        return '<button type="button" data-dock-hash="'.concat(
          l.href,
          '" class="dock-btn flex flex-1 flex-col items-center gap-1 rounded-full px-1 py-2 motion-safe:transition-colors motion-safe:duration-200 motion-safe:ease-out text-tsg-muted-cream hover:text-tsg-off-white" data-nav-id="',
          l.id,
          '">',
          dockSvg(l.id),
    ...
    var shellMain =
      ...
      '" alt="" class="tsg-hero-bg-drift motion-safe:will-change-transform absolute inset-0 h-full w-full object-cover motion-safe:brightness-[0.94] motion-safe:contrast-[1.04]" fetchpriority="high" decoding="async" /><div class="pointer-events-none absolute inset-0 bg-gradient-to-b from-black/30 via-black/35 to-[#1A302699]"></div><div class="relative z-10 mx-auto flex max-w-5xl flex-col items-center px-6 pb-28 pt-20 text-center md:px-10 tsg-hero-in"><p class="mb-4 font-sans text-xs font-medium uppercase tracking-[0.25em] text-tsg-gold md:text-sm">' +
      esc(s.heroKicker) +
      ...
      esc(s.heroTagline) +
      '</p><div class="mt-10 flex w-full max-w-md flex-col items-center gap-4 sm:flex-row sm:justify-center"><a href="#contact" class="js-scroll-nav motion-safe:transition-all motion-safe:duration-300 motion-safe:ease-out inline-flex h-12 w-full min-w-[200px] items-center justify-center rounded-full bg-tsg-gold px-8 font-sans text-sm font-semibold uppercase tracking-wider text-tsg-deep shadow-[0_8px_40px_rgba(0,0,0,0.35)] hover:bg-tsg-gold-hover hover:shadow-[0_12px_44px_rgba(0,0,0,0.42)] active:translate-y-px sm:w-auto">' +
      esc(s.reserveHero) +
      '</a><a href="#menu" class="js-scroll-nav motion-safe:transition-all motion-safe:duration-300 motion-safe:ease-out inline-flex h-12 w-full min-w-[200px] items-center justify-center rounded-full border border-tsg-gold/80 px-8 font-sans text-sm font-medium uppercase tracking-wider hover:border-tsg-gold hover:bg-white/[0.04] active:translate-y-px sm:w-auto">' +
      esc(s.menuHero) +
      '</a></div></div><a href="#about" class="absolute bottom-8 left-1/2 flex -translate-x-1/2 flex-col items-center gap-1 motion-safe:transition-colors motion-safe:duration-300 text-tsg-off-white/78 hover:text-tsg-off-white" aria-label="' +
      ...
      '<section id="about" aria-labelledby="about-heading" data-tsg-reveal class="border-t border-white/[0.08] bg-tsg-deep"><div class="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 py-[4.5rem] md:px-12 lg:grid-cols-2 lg:gap-20 lg:px-20 xl:py-[7.5rem]"><article class="order-2 flex flex-col justify-center space-y-8 lg:order-1"><p class="font-sans text-xs font-semibold uppercase tracking-[0.2em] text-tsg-gold">' +
      esc(s.aboutLabel) +
      ...
      esc(s.aboutLink) +
      '<span aria-hidden="true">→</span></a></p></article><div class="order-1 lg:order-2"><div class="group/about relative mx-auto aspect-[3/4] max-w-md overflow-hidden rounded-sm border border-[rgba(197,160,89,0.25)] lg:mx-0 lg:mr-12 lg:max-w-none shadow-[8px_8px_0_0_rgba(197,160,89,0.25)]"><img src="' +
      esc(typeof IMAGE_ASSETS !== "undefined" ? IMAGE_ASSETS.about_image : "") +
      '" alt="' +
      esc(s.aboutImgAlt) +
      '" class="h-full w-full object-cover motion-safe:transition-transform motion-safe:duration-[1.1s] motion-safe:ease-out motion-safe:will-change-transform group-hover/about:scale-[1.03]"/><div class="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(0,0,0,0.28)_85%)]"></div><span class="absolute bottom-4 left-4 rounded-full border border-[rgba(197,160,89,0.18)] bg-[rgba(33,58,46,0.55)] px-5 py-2 font-sans text-xs font-semibold uppercase tracking-[0.15em] backdrop-blur-md">' +
      esc(s.sinceBadge) +
      '</span></div></div></div></section>' +
      '<section id="menu" aria-labelledby="menu-heading" data-tsg-reveal class="border-t border-white/[0.12] bg-tsg-deep">' +
      ...
      '<section id="gallery" aria-labelledby="gallery-heading" data-tsg-reveal class="border-t border-white/[0.12] bg-[#15261e]"><div class="mx-auto max-w-7xl px-6 py-[4.5rem] md:px-12 lg:px-20 xl:py-[7.5rem]"><header class="max-w-3xl space-y-4"><p class="font-sans text-xs font-semibold uppercase tracking-[0.2em] text-tsg-gold">' +
      esc(s.galleryLabel) +
      ...
      "</div></div></section>" +
      '<footer id="contact" aria-labelledby="contact-heading" data-tsg-reveal class="relative border-t border-white/[0.12] bg-[#132119]">' +
    ...
    var headerBlock =
      ""
        ...
        .concat(
          ...
          '">',
          langBtns,
          '</div><div class="ml-auto flex shrink-0 items-center gap-2 sm:gap-3"><a href="#contact" class="js-scroll-nav motion-safe:transition-colors motion-safe:duration-200 rounded-full bg-tsg-gold px-[1rem] py-2.5 font-sans text-[0.6875rem] font-semibold uppercase tracking-[0.14em] text-tsg-deep shadow-[0_8px_26px_rgba(0,0,0,0.32)] hover:bg-tsg-gold-hover xl:px-[1.125rem] xl:text-[0.725rem]">',
          esc(s.reserveNav),
          '</a><button type="button" id="mob-toggle" aria-expanded="false" aria-controls="mobile-nav-drawer" aria-label="',
          esc(s.burgerOpen),
          '" class="motion-safe:transition-colors motion-safe:duration-200 flex h-[46px] w-[46px] items-center justify-center rounded-full border border-tsg-gold/35 bg-white/[0.03] text-tsg-off-white hover:border-tsg-gold/55 hover:bg-white/[0.05] lg:hidden"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="1.55" stroke-linecap="round" d="M4 7h16M4 12h16M4 17h16"/></svg></button></div></div></header>',
        );
  ...
  function renderMenu(cat, lang) {
    ...
    var html = filtered
      ...
      .join("");
    var tabId = "menu-tab-".concat(cat);

    function apply() {
      wrap.innerHTML = html;
      wrap.setAttribute("aria-labelledby", tabId);
      wrap.classList.remove("is-muted");
    }

    if (prefersReducedMotion() || wrap.children.length === 0) {
      wrap.removeAttribute("data-tsg-fade-ready");
      wrap.classList.remove("is-muted");
      wrap.innerHTML = html;
      wrap.setAttribute("aria-labelledby", tabId);
      return;
    ...
    wrap.setAttribute("data-tsg-fade-ready", "true");
  ...
  function observeSectionReveals() {
    var nodes = qsa("[data-tsg-reveal]");
    if (!nodes.length) return;
    if (prefersReducedMotion()) {
      nodes.forEach(function (el) {
        el.classList.add("motion-reduce-ready", "is-visible");
      });
      return;
    }
    ...
    io = new IntersectionObserver(
      function (entries) {
        entries.forEach(function (en) {
          ...
          /** @type {HTMLElement} */
          var t = /** @type {HTMLElement} */ (en.target);
          t.classList.add("is-visible");
          if (io) io.unobserve(t);
        });
      },
      { rootMargin: "-6% 0px -14% 0px", threshold: 0.04 },
    );
    var vh =
    ...
    nodes.forEach(function (node) {
      ...
      if (vh > 0 && r.top < vh * 0.93 && r.bottom > vh * 0.05) {
