...
/**
 * =====================================================================
 * IMAGE ASSET MAP — ключі відповідають реальним файлам (assets/images/…).
 * =====================================================================
 *   hero_bg                 — fullscreen фон блоку #hero
 *   about_image             — портретний кадр у #about
 *   og_default              — загальний OG / превʼю посилання в <head>
 * ---------------------------------------------------------------------
 *   dish_syrniki_photo                  dish_oatmeal_photo
 *   dish_salmon_bruschetta_photo        dish_english_breakfast_photo
 *   dish_beef_tartare_photo             dish_eggplant_salad_photo
 *   dish_caesar_photo                   dish_ribeye_photo
 *   dish_salmon_spinach_photo           dish_carbonara_photo
 *   dish_burger_step_garden_photo
 * ---------------------------------------------------------------------
 *   drink_garden_spritz_photo           drink_step_sour_photo
 *   drink_homemade_lemonade_photo       drink_coffee_photo
 * ---------------------------------------------------------------------
 *   gallery_01 … gallery_10             — masonry #gallery → g-01…g-10
 * =====================================================================
 */
...
var IMAGE_ASSETS = {
  ...
  "dish_syrniki_photo": "https://images.unsplash.com/photo-1525351484163-7529414344d8?auto=format&fit=crop&w=900&q=80",
  "dish_oatmeal_photo": "https://images.unsplash.com/photo-1517686469429-8bdb88b9e907?auto=format&fit=crop&w=900&q=80",
  "dish_salmon_bruschetta_photo": "https://images.unsplash.com/photo-1541519227354-08fa5d50c44d?auto=format&fit=crop&w=900&q=80",
  "dish_english_breakfast_photo": "https://images.unsplash.com/photo-1528607929212-2636ec44253e?auto=format&fit=crop&w=900&q=80",
  "dish_beef_tartare_photo": "https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=900&q=80",
  "dish_eggplant_salad_photo": "https://images.unsplash.com/photo-1547592186-897a5c8d4374?auto=format&fit=crop&w=900&q=80",
  "dish_caesar_photo": "https://images.unsplash.com/photo-1546793660972-ed97ebeb8d74?auto=format&fit=crop&w=900&q=80",
  "dish_ribeye_photo": "https://images.unsplash.com/photo-1546833999-b9f581a1996d?auto=format&fit=crop&w=900&q=80",
  "dish_salmon_spinach_photo": "https://images.unsplash.com/photo-1467003909585-2f8a72700288?auto=format&fit=crop&w=900&q=80",
  "dish_carbonara_photo": "https://images.unsplash.com/photo-1621996346565-e3dbc353d2e5?auto=format&fit=crop&w=900&q=80",
  "dish_burger_step_garden_photo": "https://images.unsplash.com/photo-1550547660-d9550caf797d?auto=format&fit=crop&w=900&q=80",
  "drink_garden_spritz_photo": "https://images.unsplash.com/photo-1551538827-9c037cb4f32a?auto=format&fit=crop&w=900&q=80",
  "drink_step_sour_photo": "https://images.unsplash.com/photo-1514362545857-3bc16549766b?auto=format&fit=crop&w=900&q=80",
  "drink_homemade_lemonade_photo": "https://images.unsplash.com/photo-1523676392389-ac9bf3ba8e9e?auto=format&fit=crop&w=900&q=80",
  "drink_coffee_photo": "https://images.unsplash.com/photo-1495474478417-f9d673be55a9?auto=format&fit=crop&w=900&q=80",
 ...
 */
var LANG_DATA = {"STRINGS":{"uk":{"metaTitle":"The Step Garden — gastrobar Urban Jungle (Болгарія)","metaDesc":"The Step Garden: сніданки, салати, основні та напої в Болгарії (Софія / Варна). Ціни в левах (BGN). Мови: UA · BG · EN.","skipLink":"До основного вмісту","navDeskAria":"Розділи сайту (десктоп)","langGroupAria":"Мова сайту","heroBannerAria":"Головний банер","menuTabsAria":"Категорії меню","navMobSections":"Мобільні розділи","navDockAria":"Нижня панель навігації","burgerOpen":"Меню","drawerClose":"Закрити меню","brandShortAria":"The Step Garden — на головну","brandHomeAria":"The Step Garden — на початок","navHome":"Головна","navAbout":"Про нас","navMenu":"Меню","navGallery":"Галерея","navContact":"Контакти","dockAbout":"Про нас","dockMenu":"Їжа","dockGallery":"Фото","dockContact":"Зв'язок","reserveNav":"Забронювати","reserveDrawer":"Забронювати стіл","reserveHero":"Забронювати столик","menuHero":"Меню","scrollDown":"Вниз","heroKicker":"Gastrobar · Urban Jungle · Болгарія","scrollAboutAria":"Прокрутити до блоку про нас","heroTagline":"Там, де місто зустрічається з дикою природою","aboutLabel":"Наша історія","aboutTitle":"Сад у серці міста — Софія чи Варна","aboutP1":"The Step Garden зібрав urban jungle: зелень, камінь, тепле світло й увага до деталей на столі.","aboutP2":"Локація в Болгарії — Софія або Варна (актуальну адресу й бронь дивіться в Instagram @the.step.garden).","aboutP3":"Завітайте на сніданок, ланч або вечірній напій — сезонне меню та чесні порції.","aboutFoot":"Усі ціни на сайті — у болгарських левах (BGN).","aboutLink":"До меню","aboutImgAlt":"Інтер’єр The Step Garden — urban jungle","sinceBadge":"З 2024","menuLabel":"Гастрономія","menuTitle":"Меню The Step Garden","menuIntro":"Чотири вкладки: сніданки, салати й закуски, основні страви та напої. У кожної позиції — склад і вага порції.","tabBreakfasts":"Сніданки","tabSalads":"Салати та закуски","tabMains":"Основне","tabDrinks":"Напої","galleryLabel":"Атмосфера","galleryTitle":"Сад на столі й у деталях","galleryIntro":"Світло, текстури, напої та сервіс — короткий візуальний настрій закладу.","contactLabel":"Контакти","contactTitle":"The Step Garden","contactIntro":"Графік, адреса в Болгарії, телефон +359 … та Instagram — перед візитом або бронюванням.","hoursTitle":"Час роботи","hoursCaption":"Таблиця годин роботи","addrTitle":"Адреса","copyBtn":"Скопіювати адресу","copyOk":"Адресу скопійовано.","copyLiveOk":"Адресу скопійовано (оголошення для скрінрідера).","copyFail":"Скопіюйте текст вручну.","phoneTitle":"Телефон","socialTitle":"Instagram","routeBtn":"Маршрут у карті","mapNote":"Карта зосереджена на Софії; точний пін або Варна — у профілі @the.step.garden.","mapIframeTitle":"Карта Google","footerRights":"Усі права захищено","lightboxClose":"Закрити","lightboxAria":"Збільшене зображення з галереї","schemaDesc":"Гастробар у Болгарії: меню, напої та зелений інтер’єр (Софія / Варна).","schemaCuisine1":"Європейська","schemaCuisine2":"Авторська","schemaReserve":"Забронювати столик","jsonLdReserve":"Забронювати столик","addressLine":"Болгарія — Софія / Варна (уточнюйте в Instagram @the.step.garden)","hoursMonFri":"Понеділок – П’ятниця","hoursSat":"Субота","hoursSun":"Неділя","badgeNew":"Новинка","badgeChef":"Вибір шефа","badgePopular":"Хіт","pricePrefixFrom":"від"},"bg":{"metaTitle":"The Step Garden — гастробар Urban Jungle, България","metaDesc":"Закуски, салати, основни ястия и напитъци; цени в лева (BGN). Езици: UA · BG · EN.","skipLink":"Към основното съдържание","navDeskAria":"Раздели (десктоп)","langGroupAria":"Език на сайта","heroBannerAria":"Главен банер","menuTabsAria":"Категории меню","navMobSections":"Мобилни раздели","navDockAria":"Долна лента за навигация","burgerOpen":"Меню","drawerClose":"Затвори","brandShortAria":"The Step Garden — начало","brandHomeAria":"The Step Garden — горе на страницата","navHome":"Начало","navAbout":"За нас","navMenu":"Меню","navGallery":"Галерия","navContact":"Контакти","dockAbout":"За нас","dockMenu":"Храна","dockGallery":"Снимки","dockContact":"Контакти","reserveNav":"Резервация","reserveDrawer":"Резервирай маса","reserveHero":"Резервирай","menuHero":"Меню","scrollDown":"Надолу","heroKicker":"Gastrobar · Urban Jungle · България","scrollAboutAria":"Превъртане към секция за нас","heroTagline":"Където градът среща дивата природа","aboutLabel":"Нашата история","aboutTitle":"Градина в сърцето на града — София или Варна","aboutP1":"The Step Garden събира urban jungle: зеленина, камък, топла светлина и внимание към детайла.","aboutP2":"Реалната локация в България — София или Варна; вижте Instagram @the.step.garden.","aboutP3":"Закуска, обяд или вечер — сезонно меню и ясни порции в лева (BGN).","aboutFoot":"Цените в менюто са в български лева (BGN).","aboutLink":"Към менюто","aboutImgAlt":"Интериор The Step Garden","sinceBadge":"От 2024","menuLabel":"Гастрономия","menuTitle":"Меню The Step Garden","menuIntro":"Четири категории: закуски, салати и предястия, основни и напитъци — всяко ястие със състав и грамаж.","tabBreakfasts":"Закуски","tabSalads":"Салати и предястия","tabMains":"Основни","tabDrinks":"Напитки","galleryLabel":"Атмосфера","galleryTitle":"Атмосферата на градината","galleryIntro":"Светлина, текстури, напитки и сервиз.","contactLabel":"Контакти","contactTitle":"The Step Garden","contactIntro":"Работно време, адрес в България, телефон +359 … и Instagram преди посещение.","hoursTitle":"Работно време","hoursCaption":"Часово разписание","addrTitle":"Адрес","copyBtn":"Копирай адреса","copyOk":"Адресът е копиран.","copyLiveOk":"Адресът е копиран (потвърждение за четци на екрана).","copyFail":"Копирайте ръчно.","phoneTitle":"Телефон","socialTitle":"Instagram","routeBtn":"Маршрут","mapNote":"Картата е към центъра на София; точен адрес или Варна — в Instagram.","mapIframeTitle":"Карта","footerRights":"Всички права запазени","lightboxClose":"Затвори","lightboxAria":"Увеличена снимка","schemaDesc":"Гастробар в България: меню, напитки и urban jungle интериор.","schemaCuisine1":"Европейска","schemaCuisine2":"Авторска","schemaReserve":"Резервирай маса","jsonLdReserve":"Резервирай маса","addressLine":"България — София / Варна (уточнявайте в Instagram @the.step.garden)","hoursMonFri":"Понеделник – Петък","hoursSat":"Събота","hoursSun":"Неделя","badgeNew":"Новинка","badgeChef":"Вибір шефа","badgePopular":"Хіт","pricePrefixFrom":"от"},"en":{"metaTitle":"The Step Garden — Urban Jungle gastrobar, Bulgaria","metaDesc":"Breakfasts, salads, mains & drinks in Bulgarian lev (BGN). Languages: Ukrainian, Bulgarian, English.","skipLink":"Skip to main content","navDeskAria":"Site sections (desktop)","langGroupAria":"Site language","heroBannerAria":"Hero banner","menuTabsAria":"Menu categories","navMobSections":"Mobile sections","navDockAria":"Bottom quick navigation","burgerOpen":"Menu","drawerClose":"Close menu","brandShortAria":"The Step Garden — home","brandHomeAria":"The Step Garden — scroll to top","navHome":"Home","navAbout":"About","navMenu":"Menu","navGallery":"Gallery","navContact":"Contact","dockAbout":"About","dockMenu":"Food","dockGallery":"Photos","dockContact":"Contact","reserveNav":"Book a table","reserveDrawer":"Reserve a table","reserveHero":"Book a table","menuHero":"Menu","scrollDown":"Scroll","heroKicker":"Gastrobar · Urban Jungle · Bulgaria","scrollAboutAria":"Scroll to the About section","heroTagline":"Where the city meets the wild","aboutLabel":"Our story","aboutTitle":"A garden in Sofia — or Varna","aboutP1":"We shaped an intimate urban jungle — greenery, honest materials and warm evening light.","aboutP2":"Serving Bulgaria’s coast or capital: confirm Sofia versus Varna on Instagram @the.step.garden.","aboutP3":"Drop in for breakfast, a long lunch, or botanical cocktails.","aboutFoot":"Listed prices use Bulgarian lev (BGN).","aboutLink":"Browse the menu","aboutImgAlt":"Interior of The Step Garden","sinceBadge":"Since 2024","menuLabel":"Gastronomy","menuTitle":"The Step Garden menu","menuIntro":"Four tabs — breakfasts, salads & starters, mains, drinks — each card lists ingredients and portion weight.","tabBreakfasts":"Breakfast","tabSalads":"Salads & starters","tabMains":"Mains","tabDrinks":"Drinks","galleryLabel":"Atmosphere","galleryTitle":"Garden details & light","galleryIntro":"Ambience — plants, warm light, service moments.","contactLabel":"Contact","contactTitle":"The Step Garden","contactIntro":"Hours, Bulgarian address, +359 phone placeholder, and Instagram before you visit.","hoursTitle":"Opening hours","hoursCaption":"Opening hours table","addrTitle":"Address","copyBtn":"Copy address","copyOk":"Address copied.","copyLiveOk":"Announcement: address copied.","copyFail":"Copy manually.","phoneTitle":"Phone","socialTitle":"Instagram","routeBtn":"Directions","mapNote":"Map pins central Sofia — cross-check venue city on Instagram.","mapIframeTitle":"Map","footerRights":"All rights reserved","lightboxClose":"Close viewer","lightboxAria":"Expanded gallery photograph","schemaDesc":"Urban Jungle gastrobar in Bulgaria (Sofia / Varna) with authored food & drinks.","schemaCuisine1":"European","schemaCuisine2":"Contemporary","schemaReserve":"Book a table","jsonLdReserve":"Book a table","addressLine":"Bulgaria — Sofia / Varna (confirm on Instagram @the.step.garden)","hoursMonFri":"Monday – Friday","hoursSat":"Saturday","hoursSun":"Sunday","badgeNew":"New","badgeChef":"Chef’s pick","badgePopular":"Popular","pricePrefixFrom":"from"}},"MENU_TR":{"bg":{"br-syrniki":{"name":"Сиренца с горски плодове","ingredientLine":"мляко · яйце · брашно · горски плодове · заквасено млеко · цитрова корички"},"br-oats":{"name":"Овесена каша с банан","ingredientLine":"овес · мляко / растителна напитка · карамелизиран банан · орехи · мед"},"br-salmon-br":{"name":"Брускети сьомга","ingredientLine":"хлеб · крем сир · слабо солена сьомга · маринована краставица · копър"},"br-english":{"name":"Английска закуска","ingredientLine":"яйце · суджук/бекон · боб доматено · гъби · препечен хляб · BBQ сос"},"sal-tartare":{"name":"Телешки тартар","ingredientLine":"телешко филе · горчица · каперси · лук шалот · яйчен жълтък · бриош"},"sal-eggplant":{"name":"Хрупкава патладжан салата","ingredientLine":"печен патладжан · рукола · чери домати · айран-дресинг · нар · орех"},"sal-caesar":{"name":"Цезар с пилешко от грил","ingredientLine":"айсберг · пилешко · пармезан · цезар сос · крутон · аншоус"},"mn-ribeye":{"name":"Рибай стек","ingredientLine":"ribeye matured · морска сол · черен пипер · винено редукция · гарнитура"},"mn-salmon":{"name":"Сьомга со спанак","ingredientLine":"сьомга · пресен спанак · масло с лимон и капери · млади картофи"},"mn-carbonara":{"name":"Карбонара","ingredientLine":"пресна паста · жълтък · гуанчиале · пекорино · черен пипер"},"mn-burger":{"name":"Бургер The Step Garden","ingredientLine":"говежда смес · бриош · чедър · айсберг · кисела краставичка · зелено айоли"},"dr-spritz":{"name":"Garden Spritz","ingredientLine":"просекко · билков шраб · содова · лимонена кора · мента"},"dr-sour":{"name":"Step Sour","ingredientLine":"американско уиски · лимон · захарен сироп · битер · белтък по желание"},"dr-lemonade":{"name":"Домашен лимонад","ingredientLine":"лимон · прост сироп · мента · газирана или вода · лед"},"dr-coffee":{"name":"Кафе","ingredientLine":"еспресо смес · опция за млеко · алтернативни напитки"}},"en":{"br-syrniki":{"name":"Syrniki & berries","ingredientLine":"quark · egg · light flour · seasonal berries · sour cream · citrus zest"},"br-oats":{"name":"Caramel-banana oatmeal","ingredientLine":"oat flakes · milk / oat drink · caramelised banana · walnuts · maple"},"br-salmon-br":{"name":"Salmon bruschetta","ingredientLine":"artisan loaf · cream cheese · lightly cured salmon · pickle · dill"},"br-english":{"name":"Full English platter","ingredientLine":"eggs any style · bacon or sausage · baked beans · mushrooms · toast"},"sal-tartare":{"name":"Beef tartare","ingredientLine":"beef tenderloin · mustard emulsion · capers · pickles · brioche crisps · yolk"},"sal-eggplant":{"name":"Crispy aubergine salad","ingredientLine":"fried aubergine · rocket · cherry tomatoes · mint yogurt · pomegranate · hazelnuts"},"sal-caesar":{"name":"Grilled chicken Caesar","ingredientLine":"romaine · grilled chicken breast · parmesan · Caesar dressing · croutons"},"mn-ribeye":{"name":"Rib-eye steak","ingredientLine":"aged rib-eye · rosemary · pepper jus · seasonal sides"},"mn-salmon":{"name":"Salmon & spinach","ingredientLine":"salmon fillet · wilted spinach · citrus-caper butter · young potatoes"},"mn-carbonara":{"name":"Carbonara","ingredientLine":"fresh spaghetti · egg yolk · guanciale · pecorino · black pepper"},"mn-burger":{"name":"“The Step Garden” burger","ingredientLine":"beef patty · brioche · cheddar · iceberg · pickles · herb mayo"},"dr-spritz":{"name":"Garden Spritz","ingredientLine":"sparkling wine · botanical cordial · soda · citrus · mint sprig"},"dr-sour":{"name":"Step Sour","ingredientLine":"straight bourbon · lemon juice · cane syrup · aromatic bitters · optional egg white"},"dr-lemonade":{"name":"Homemade lemonade","ingredientLine":"fresh lemons · syrup · mint · sparkling or still · ice"},"dr-coffee":{"name":"Coffee","ingredientLine":"single-origin espresso · milk add-on · oat or almond on request"}}},"GALLERY_ALT":{"bg":{"g-01":"Изглед към салона с топла светлина","g-02":"Голям план маса между растения","g-03":"Височки край бар плота","g-04":"Поднесено основно ястие","g-05":"Подредени предястия","g-06":"Коктейл с билки и цитрос","g-07":"Подправки върху камък","g-08":"Зимен напитков бар","g-09":"Кът до прозореца","g-10":"Маса с цветя"},"en":{"g-01":"Dining room panorama with soft lighting","g-02":"Vertical vignette amid plants","g-03":"High tops near the bar","g-04":"Plated mains from the kitchen","g-05":"Line-up of grazing plates","g-06":"Garden-forward cocktail garnish","g-07":"Spices and herbs over stone","g-08":"Festive mulled pours","g-09":"Window lounge seating","g-10":"Table nestled in fresh blooms"}}};

var MENU_ITEMS = [
  {
    "id": "br-syrniki",
    "name": "Сирники з ягодами та сметаною",
    "weight": "220 г",
    "ingredients": [
      "кисломолочний сир",
      "яйця",
  ...
  {
    "id": "br-oats",
    "name": "Вівсянка з карамелізованим бананом",
    "weight": "280 г",
    "ingredients": [
      "вівсяні пластівки",
      "молоко або рослинна основа",
      "банан",
      "горіхи",
      "мед",
      "щіпка солі"
    ...
    "price": 12,
    "image": "https://images.unsplash.com/photo-1517686469429-8bdb88b9e907?auto=format&fit=crop&w=900&q=80",
    "category": "breakfasts"
  },
  {
    "id": "br-salmon-br",
    "name": "Брускети з лососем слабосоленим",
    "weight": "240 г",
    "ingredients": [
  ...
  {
    "id": "br-english",
    "name": "Англійський сніданок «The Garden»",
    "weight": "420 г",
    "ingredients": [
      "яйця пашот або яєчня",
      "ковбаски / бекон гриль",
      "фасоля в томаті",
      "печериці",
      "тост",
      "соус BBQ"
  ...
  {
    "id": "sal-tartare",
    "name": "Тартар із яловичої вирізки",
    "weight": "180 г",
    "ingredients": [
      "яловича вирізка",
      "гірчиця та каперси",
  ...
  {
    "id": "sal-eggplant",
    "name": "Салат із хрумких баклажанів",
    "weight": "260 г",
    "ingredients": [
      "баклажан обсмажений",
      "рукола",
      "томати чері",
      "йогуртно-м’ятний соус",
      "гранат",
      "горіх лісовий"
    ],
    "price": 18,
    "image": "https://images.unsplash.com/photo-1547592186-897a5c8d4374?auto=format&fit=crop&w=900&q=80",
    "category": "salads"
  },
  {
    "id": "sal-caesar",
    "name": "Салат «Цезар» з куркою гриль",
    "weight": "320 г",
    "ingredients": [
      "салат ромен",
      "філе курячої грудки гриль",
      "пармезан",
      "соус Caesar",
      "крутони",
      "анчоусна емульсія"
  ...
  {
    "id": "mn-ribeye",
    "name": "Стейк рибай з перцевим соусом",
    "weight": "320 г + гарнір",
    "ingredients": [
      "рибай",
      "морська сіль",
  ...
  {
    "id": "mn-salmon",
    "name": "Лосось зі шпинатом і лимонним маслом",
    "weight": "380 г",
    "ingredients": [
      "філе лосося",
      "шпинат",
  ...
  },
  {
    ...
    "price": 24,
    "image": "https://images.unsplash.com/photo-1550547660-d9550caf797d?auto=format&fit=crop&w=900&q=80",
    "category": "mains",
    "badge": "New"
  },
  {
  ...
  },
  {
    ...
    "price": 20,
    "image": "https://images.unsplash.com/photo-1514362545857-3bc16549766b?auto=format&fit=crop&w=900&q=80",
    "category": "drinks",
    "badge": "Chef's Pick"
  },
  {
    ...
    "ingredients": [
      ...
      "цукровий сироп",
      "ментол свіжий",
      "газована або негазована вода",
      "лід"
    ],
    "price": 12,
    "image": "https://images.unsplash.com/photo-1523676392389-ac9bf3ba8e9e?auto=format&fit=crop&w=900&q=80",
    "category": "drinks"
  },
  {
    "id": "dr-coffee",
    "name": "Кава espresso / чорна / із молоком",
    "weight": "30–280 мл",
    "ingredients": [
      "арабіка single-origin",
      "молоко за бажанням"
    ],
    "price": 6,
    "priceFrom": true,
    "image": "https://images.unsplash.com/photo-1495474478417-f9d673be55a9?auto=format&fit=crop&w=900&q=80",
    "category": "drinks"
  }
];
...
(function () {
  ...
  function buildRestaurantJsonLd(lc) {
    ...
    var menuSections = [];
    /** @type {string[]} */
    var order = ["breakfasts", "salads", "mains", "drinks"];
    for (var si = 0; si < order.length; si++) {
      ...
      var itemsInCat = MENU_ITEMS.filter(function (m) {
        ...
        off.price =
          item.priceFrom === true ? "from ".concat(String(item.price)) : String(item.price);
        /** @type {Record<string, any>} */
        var mi = {
          "@type": "MenuItem",
  ...
  /** @returns {string} */
  function bgnFmtFallback(n) {
    return "".concat(new Intl.NumberFormat("bg-BG").format(n), "\u00A0лв.");
  }
    ...
    var loc =
      lc === "uk"
        ...
        : lc === "bg"
          ...
          : "en-GB";
    try {
      var num = new Intl.NumberFormat(loc, { maximumFractionDigits: 0 }).format(
        n,
      );
      return "".concat(num, "\u00A0лв.");
    } catch {
      return bgnFmtFallback(n);
    }
  }
